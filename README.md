...
(У меня шизофрения)
### Как это работает?
|Приветствие и механизм подписки|Вывод статистики по команде|Рассылка статистики подписчикам|
|---|---|---|
|![scr1](assets/scr.PNG)|![scr2](assets/scr1.PNG)|![scr2](assets/scr2.PNG)|
### Доступные команды
|Команда                    |Описание                                                                           |
|---------------------------|-----------------------------------------------------------------------------------|
